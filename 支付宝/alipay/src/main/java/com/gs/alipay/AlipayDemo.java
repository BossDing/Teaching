...
public class AlipayDemo {
    private static Log                  log = LogFactory.getLog(AlipayDemo.class);
    ...
    public static void main(String[] args) {
        AlipayDemo alipayDemo= new AlipayDemo();
        alipayDemo.test_trade_pay(tradeService);
    }
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        String authCode = "283979721252397923"; // 条码示例，286648048691290423
