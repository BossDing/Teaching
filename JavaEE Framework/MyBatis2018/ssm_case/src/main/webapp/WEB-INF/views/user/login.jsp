...
<body>
    <div style="margin:auto; width:600px; height:400px;padding-top:200px;">
        <div style="float:left;width:60%;"><img style="width:360px;height:175px;"src="<%=path%>/static/images/girl.jpg"></div>
        <div class="easyui-panel" data-options="title:'登录'" style="float:left;width:40%;">
            <form id="loginForm">
                <table>
                    ...
                    <tr>
                        <td>
                           <img src="<%=path%>/code/png" onclick="this.src='<%=path%>/code/png?r=' + Math.random();"/>
                        </td>
                    </tr>
                    <tr>
