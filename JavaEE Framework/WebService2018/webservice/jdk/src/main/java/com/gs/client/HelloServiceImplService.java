 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://server.gs.com/", wsdlLocation = "http://127.0.0.1/webservice/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://server.gs.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1/webservice/hello?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://server.gs.com/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.gs.com/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
