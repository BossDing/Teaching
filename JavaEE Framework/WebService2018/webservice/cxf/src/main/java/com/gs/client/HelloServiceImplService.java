...
@WebServiceClient(name = "HelloServiceImplService",
                  ...
                  targetNamespace = "http://server.gs.com/")
public class HelloServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.gs.com/", "HelloServiceImplService");
    public final static QName HelloServiceImplPort = new QName("http://server.gs.com/", "HelloServiceImplPort");
    static {
        URL url = null;
        try {
